<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_100_rowheight_lineclamp.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridrowheight.grid_100_rowheight_lineclamp" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Height="500px" ShowBorder="true" ShowHeader="true" Title="100行（行高固定）"
            EnableCollapse="false" runat="server" EnableCheckBoxSelect="true" KeepCurrentSelection="true"
            ...
            <Columns>
                ...
                <f:BoundField Width="500px" DataField="Desc" HeaderText="个人简介" />
