<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_fixedrowheight_rowdensity.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_fixedrowheight_rowdensity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" Height="650px" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false" EnableCheckBoxSelect="true"
            RowDensity="Default" FixedRowHeight="true" RowHeightLines="3">
            <Columns>
                <f:RowNumberField />
