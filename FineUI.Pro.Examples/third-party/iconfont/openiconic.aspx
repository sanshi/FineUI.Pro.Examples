<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="openiconic.aspx.cs" Inherits="FineUI.Pro.Examples.thirdparty.iconfont.openiconic" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" Width="500px" runat="server" Title="面板" Height="250px"
            ...
            <Tools>
                <f:Tool runat="server" IconFontClass="oi oi-cog" ToolTip="设置" ClickHandler="onToolIconClick"></f:Tool>
                <f:Tool runat="server" IconFontClass="oi oi-cloud-download" ToolTip="下载" ClickHandler="onToolIconClick"></f:Tool>
            </Tools>
            <Toolbars>
                <f:Toolbar runat="server" Position="Bottom" ToolbarAlign="Right">
                    <Items>
                        <f:Button ID="btnMenu" Text="操作" IconFontClass="oi oi-pencil" runat="server">
                            <Menu runat="server">
                                <f:MenuButton runat="server" IconFontClass="oi oi-trash" Text="删除选中项">
                                </f:MenuButton>
                                <f:MenuButton runat="server" IconFontClass="oi oi-ban" Text="禁用选中项">
                                </f:MenuButton>
                            </Menu>
                        </f:Button>
                    </Items>
