<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckeditor_window.aspx.cs" ValidateRequest="false"
    Inherits="FineUI.Pro.Examples.aspnet.ckeditor_window" %>
                ...
                <f:SimpleForm ID="SimpleForm1" Layout="Fit" runat="server" LabelAlign="Top" ShowBorder="false" ShowHeader="false">
                    <Items>
                        <f:HtmlEditor runat="server" Label="文本编辑器" ID="HtmlEditor1"
                            Editor="CKEditor" BasePath="~/res/third-party/ckeditor/" ToolbarSet="Full">
                            <Options>
                                <f:OptionItem Key="baseFloatZIndex" Value="99999" />
                            </Options>
                        </f:HtmlEditor>
                    </Items>
                </f:SimpleForm>
