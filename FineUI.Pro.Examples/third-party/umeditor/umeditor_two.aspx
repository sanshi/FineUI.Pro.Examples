<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="umeditor_two.aspx.cs" ValidateRequest="false"
    Inherits="FineUI.Pro.Examples.aspnet.umeditor_two" %>
        ...
        <f:SimpleForm ID="Form1" IsFluid="true" BodyPadding="10px" EnableCollapse="false"
            ...
            <Items>
                ...
                <f:HtmlEditor runat="server" Label="文章正文" ID="HtmlEditor1"
                    Editor="UMEditor" BasePath="~/res/third-party/umeditor/" ToolbarSet="Full" Height="400px">
                </f:HtmlEditor>
                <f:HtmlEditor runat="server" Label="文章摘要" ID="HtmlEditor2"
                    Editor="UMEditor" BasePath="~/res/third-party/umeditor/" ToolbarSet="Basic" Height="200px">
                </f:HtmlEditor>
            </Items>
            <Toolbars>
