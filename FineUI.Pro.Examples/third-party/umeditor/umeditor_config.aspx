<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="umeditor_config.aspx.cs" ValidateRequest="false"
    Inherits="FineUI.Pro.Examples.aspnet.umeditor_config" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" LabelAlign="Top" EnableCollapse="false"
            Title="表单">
            <Items>
                <f:HtmlEditor runat="server" Label="文本编辑器" ID="HtmlEditor1"
                    Editor="UMEditor" BasePath="~/res/third-party/umeditor/" ToolbarSet="Full" Height="350px">
                    <Options>
