<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="umeditor_tabstrip.aspx.cs" ValidateRequest="false"
    Inherits="FineUI.Pro.Examples.aspnet.umeditor_tabstrip" %>
                ...
                <f:Tab ID="Tab1" Title="选项卡一" BodyPadding="10px" Layout="Anchor" runat="server">
                    <Items>
                        <f:HtmlEditor runat="server" Label="编辑器一" ID="HtmlEditor1"
                            Editor="UMEditor" BasePath="~/res/third-party/umeditor/" ToolbarSet="Full" Height="300px">
                        </f:HtmlEditor>
                    </Items>
                </f:Tab>
                <f:Tab ID="Tab2" Title="选项卡二" BodyPadding="10px" Layout="Fit" runat="server">
                    <Items>
                        <f:HtmlEditor runat="server" Label="编辑器二" ID="HtmlEditor2"
                            Editor="UMEditor" BasePath="~/res/third-party/umeditor/" ToolbarSet="Basic">
                        </f:HtmlEditor>
                    </Items>
                </f:Tab>
            </Tabs>
