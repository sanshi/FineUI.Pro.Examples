<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webuploader.aspx.cs" Inherits="FineUI.Pro.Examples.thirdparty.webuploader" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" runat="server" ShowHeader="true" ShowBorder="true" Title="文件上传"
            Height="350px"
            ...
            <Toolbars>
                <f:Toolbar runat="server">
                    <Items>
                        <%-- 禁用按钮：CssClass="webuploader-pick-disable" --%>
            ...
            <Columns>
                ...
                <f:LinkButtonField ColumnID="Delete" ConfirmText="你确定要删除这个文件吗？" ConfirmTarget="Top"
    ...
    <script type="text/javascript">
        ...
        F.ready(function () {
            ...
            // 一次添加多个文件会导致多次表格布局，从而影响性能（在 filesQueued 中一次性添加）
            //// 当文件被加入队列以后触发
