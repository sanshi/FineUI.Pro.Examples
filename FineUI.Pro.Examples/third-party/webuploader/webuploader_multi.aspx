<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webuploader_multi.aspx.cs" Inherits="FineUI.Pro.Examples.thirdparty.webuploader_multi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" IsFluid="true" BodyPadding="10px" EnableCollapse="false" Height="350px"
                ...
                <f:FormRow>
                    <Items>
                        <f:Grid ID="Grid1" runat="server" ShowHeader="true" ShowBorder="true" Title=""
                            ...
                            <Tools>
                                <f:Tool runat="server" ID="btnSelectFiles" IconFont="_Plus" Text="上传Excel"></f:Tool>
                            </Tools>
                            <Columns>
                        ...
                        <f:Grid ID="Grid2" runat="server" ShowHeader="true" ShowBorder="true" Title=""
                            ...
                            <Tools>
                                <f:Tool runat="server" ID="btnSelectFiles2" IconFont="_Plus" Text="上传图片"></f:Tool>
                            </Tools>
                            <Columns>
                                <f:BoundField ColumnID="FileName" DataField="name" DataToolTipField="name" HeaderText="文件名" ExpandUnusedSpace="true" MinWidth="150px" />
                                <f:RenderField ColumnID="FileSize" DataField="size" HeaderText="大小" Renderer="FileSize" />
