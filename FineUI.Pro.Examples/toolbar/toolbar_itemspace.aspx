<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toolbar_itemspace.aspx.cs" Inherits="FineUI.Pro.Examples.toolbar.toolbar_itemspace" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel IsFluid="true" ShowBorder="true" BodyPadding="10px" Title="面板" EnableCollapse="false"
            runat="server">
            <Toolbars>
                <f:Toolbar ItemSpace="0" runat="server">
                    <Items>
                ...
                <f:Toolbar ItemSpace="16" runat="server">
                    <Items>
