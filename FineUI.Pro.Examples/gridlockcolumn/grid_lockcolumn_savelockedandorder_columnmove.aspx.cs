...
{
    public partial class grid_lockcolumn_savelockedandorder_columnmove : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "gridlockcolumn.grid_lockcolumn_savelockedandorder_columnmove";
