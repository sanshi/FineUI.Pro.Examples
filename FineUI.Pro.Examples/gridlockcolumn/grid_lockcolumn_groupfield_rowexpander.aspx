<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn_groupfield_rowexpander.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridlockcolumn.grid_lockcolumn_groupfield_rowexpander" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" Width="1000px" EnableCollapse="false" AllowColumnLocking="true"
            ...
            Height="400px" runat="server" EnableCheckBoxSelect="true"
            OnSort="Grid1_Sort">
            <Columns>
                <f:RowNumberField />
