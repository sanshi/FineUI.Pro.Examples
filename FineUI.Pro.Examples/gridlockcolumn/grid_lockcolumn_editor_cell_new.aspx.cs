...
{
    public partial class grid_lockcolumn_editor_cell_new : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grid_lockcolumn_editor_cell_new";
