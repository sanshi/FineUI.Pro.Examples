<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_lockcolumn_column_lines.aspx.cs" Inherits="FineUI.Pro.Examples.gridlockcolumn.grid_lockcolumn_column_lines" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" Width="1000px" runat="server"
            AllowColumnLocking="true" EnableCollapse="false" EnableCheckBoxSelect="true" EnableColumnLines="true">
            <Columns>
                <f:RowNumberField />
