<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datepicker_display_time_confirmbutton.aspx.cs" Inherits="FineUI.Pro.Examples.datepicker.datepicker_display_time_confirmbutton" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" EnableCollapse="false"
            ...
            <Items>
                <f:DatePicker runat="server" Required="true" DateFormatString="HH:mm:ss" Label="开始时间" EmptyText="请选择开始时间"
                    ID="DatePicker1" ShowRedStar="true" DisplayType="Time" ShowTodayButton="false" ShowConfirmButton="true" ConfirmToSelect="true">
                </f:DatePicker>
                <f:DatePicker ID="DatePicker2" Required="true" Readonly="false" CompareControl="DatePicker1" DateFormatString="HH:mm:ss"
                    ...
                    runat="server" ShowRedStar="true" DisplayType="Time" ShowTodayButton="false" ShowConfirmButton="true" ConfirmToSelect="true">
                </f:DatePicker>
