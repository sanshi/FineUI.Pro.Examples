<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datepicker.aspx.cs" Inherits="FineUI.Pro.Examples.datepicker.datepicker" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" EnableCollapse="false"
            ...
            <Items>
                <f:DatePicker runat="server" Required="true" DateFormatString="yyyy/MM/dd" Label="开始日期" EmptyText="请选择开始日期"
                    ID="DatePicker1" ShowRedStar="true" EnableEdit="true">
                </f:DatePicker>
