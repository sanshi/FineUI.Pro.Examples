<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datepicker_yearrange_confirmbutton.aspx.cs" Inherits="FineUI.Pro.Examples.datepicker.datepicker_yearrange_confirmbutton" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" EnableCollapse="false"
            ...
            <Items>
                <f:DatePicker runat="server" Required="true" DateFormatString="yyyy" Label="年份范围" EmptyText="请选择年份范围"
                    ID="DatePicker1" ShowRedStar="true" DisplayType="YearRange" ShowConfirmButton="true" ConfirmToSelect="true">
                </f:DatePicker>
