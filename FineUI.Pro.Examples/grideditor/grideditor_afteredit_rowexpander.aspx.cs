...
{
    public partial class grideditor_afteredit_rowexpander : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_afteredit_rowexpander";
