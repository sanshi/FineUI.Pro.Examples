...
{
    public partial class grideditor_editable_cell_afteredit : PageBase
    {
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            bool atSchool = Convert.ToBoolean(row["AtSchool"]);
            if (!atSchool)
            {
                e.SetCellCssClass("Major", "f-grid-cell-uneditable");
                //RenderField rfMajor = Grid1.FindColumn("Major") as RenderField;
                //e.CellCssClasses[rfMajor.ColumnIndex] = "f-grid-cell-uneditable";
            }
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_editable_cell_afteredit";
