<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_updatesummary.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_updatesummary" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false"
            runat="server" AllowCellEditing="true"
