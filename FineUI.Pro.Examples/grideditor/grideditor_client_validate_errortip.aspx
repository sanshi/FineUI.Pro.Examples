<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_client_validate_errortip.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_client_validate_errortip" %>
...
<head runat="server">
    ...
    <style>
        .f-grid-cell.errortip {
            background-image: url(../res/images/errortip.gif);
