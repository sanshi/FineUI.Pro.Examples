<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_entersameastab.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_entersameastab" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false"
            runat="server"
            AllowCellEditing="true" ClicksToEdit="1" EnterSameAsTab="true">
            <Columns>
                <f:RowNumberField />
        ...
        <ul>
            ...
            <li>Enter、Tab 键进入水平方向的下一个单元格（如果单元格可编辑，则使其进入编辑状态）</li>
            <li>Shift+Enter、Shift+Tab 键回退到水平方向的上一个单元格（如果单元格可编辑，则使其进入编辑状态）</li>
        </ul>
    </form>
    <script>
