<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_renderfunction.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_renderfunction" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false"
            ...
            <Columns>
                ...
                <f:RenderField Width="150px" ColumnID="Salary" DataField="Salary" FieldType="Float"
                    RendererFunction="renderSalary" HeaderText="工资">
                    <Editor>
                        <f:NumberBox runat="server" Required="true" />
                    </Editor>
                </f:RenderField>
            </Columns>
        </f:Grid>
