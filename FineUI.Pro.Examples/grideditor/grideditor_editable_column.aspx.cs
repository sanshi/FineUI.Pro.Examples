...
{
    public partial class grideditor_editable_column : PageBase
    {
        ...
        protected void btnChangeEntranceDateEditable_Click(object sender, EventArgs e)
        {
            RenderField column = Grid1.FindColumn("EntranceDate") as RenderField;
            column.EnableColumnEdit = !column.EnableColumnEdit;
        }


        protected void btnChangeAtSchoolEditable_Click(object sender, EventArgs e)
        {
            RenderCheckField column = Grid1.FindColumn("AtSchool") as RenderCheckField;
            column.EnableColumnEdit = !column.EnableColumnEdit;
        }


        protected void btnChangeMajorEditable_Click(object sender, EventArgs e)
        {
            RenderField column = Grid1.FindColumn("Major") as RenderField;
            column.EnableColumnEdit = !column.EnableColumnEdit;
        }
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_editable_uneditable";
