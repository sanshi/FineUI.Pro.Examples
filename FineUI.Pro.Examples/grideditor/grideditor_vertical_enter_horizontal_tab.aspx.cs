...
{
    public partial class grideditor_vertical_enter_horizontal_tab : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_vertical_enter";
