...
{
    public partial class grideditor_dropdownlist_multi : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_dropdownlist_multi";
