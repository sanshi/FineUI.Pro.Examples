<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_vertical_enter_horizontal_tab.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_vertical_enter_horizontal_tab" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false"
            ...
            TabVerticalNavigate="false" EnterNavigate="true" EnterVerticalNavigate="true">
            <Columns>
                <f:RowNumberField />
