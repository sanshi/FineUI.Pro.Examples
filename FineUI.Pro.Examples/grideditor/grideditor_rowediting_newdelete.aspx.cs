...
{
    public partial class grideditor_rowediting_newdelete : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_rowediting_newdelete";
