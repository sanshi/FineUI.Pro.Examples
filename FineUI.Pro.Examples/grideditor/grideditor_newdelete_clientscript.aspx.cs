...
{
    public partial class grideditor_newdelete_clientscript : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_newdelete_clientscript";
