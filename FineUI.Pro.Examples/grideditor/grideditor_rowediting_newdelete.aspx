<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_rowediting_newdelete.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_rowediting_newdelete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false" runat="server" AllowCellEditing="true"
            ClicksToEdit="1" DataIDField="Id" EnableCheckBoxSelect="true" IsRowEditing="true">
            <Toolbars>
