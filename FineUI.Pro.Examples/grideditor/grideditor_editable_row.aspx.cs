...
{
    public partial class grideditor_editable_row : PageBase
    {
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            if (entranceYear <= 2002)
            {
                ...
                {
                    e.SetCellCssClass(column.ColumnID, "f-grid-cell-uneditable");
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_editable_row";
