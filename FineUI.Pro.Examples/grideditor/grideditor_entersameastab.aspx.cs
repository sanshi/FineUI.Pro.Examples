...
{
    public partial class grideditor_entersameastab : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_entersameastab";
