<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_editable_cell_style.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_editable_cell_style" %>
...
<head runat="server">
    <title></title>
    <style>
        .f-grid-cell.f-grid-cell-editable {
            padding: 3px;
        }

            .f-grid-cell.f-grid-cell-editable > .f-grid-cell-text {
                border-style: solid;
                border-width: 1px;
                border-color: #ccc;
            }

            .f-grid-cell.f-grid-cell-editable.f-grid-cell-uneditable > .f-grid-cell-text {
                border-style: none;
                opacity: 1;
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        注：本例子禁止[入学年份小于等于2002]行中[入学年份]和[入学日期]的单元格编辑。
    </form>
    <script>
