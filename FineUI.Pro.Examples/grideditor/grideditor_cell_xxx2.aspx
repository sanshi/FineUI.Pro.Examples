<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_cell_xxx2.aspx.cs" Inherits="FineUI.Pro.Examples.grideditor.grideditor_cell_xxx2" %>
...
<head runat="server">
    ...
    <title></title>
    <meta name="sourcefiles" content="~/grid/grid_editor_cell_selectfromwindow_iframe.aspx" />
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（进入编辑状态后，从弹出窗体中选择用户）" EnableCollapse="false"
            Height="350px" runat="server" AllowCellEditing="true" ShowSelectedCell="true" ClicksToEdit="1">
            <Toolbars>
            ...
            <Columns>
                <f:RowNumberField />
                <f:RenderField ColumnID="Name" DataField="Name" FieldType="String" HeaderText="姓名">
                    <Editor>
                        <f:TriggerBox ID="tbxEditorName" EnableEdit="false" TriggerIcon="Search" OnTriggerClick="tbxEditorName_TriggerClick" runat="server">
                        </f:TriggerBox>
                    </Editor>
                </f:RenderField>
                <f:RenderField ColumnID="Gender" DataField="Gender" FieldType="Int" HeaderText="性别">
                    <Editor>
                        <f:NumberBox ID="tbxEditorSex" NoDecimal="true" NoNegative="true" MinValue="0" MaxValue="1" runat="server">
                        </f:NumberBox>
                    </Editor>
                </f:RenderField>
                ...
                <f:RenderField ColumnID="Major" DataField="Major" FieldType="String" ExpandUnusedSpace="true" MinWidth="150px" HeaderText="所学专业">
                    <Editor>
