...
{
    public partial class grideditor_new_editcolumnid : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_new_editcolumnid";
