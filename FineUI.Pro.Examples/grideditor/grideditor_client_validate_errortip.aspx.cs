...
{
    public partial class grideditor_client_validate_errortip : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_client_validate_errortip";
