<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_vertical_enter_scrollbar.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_vertical_enter_scrollbar" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false" Height="300px"
            runat="server"
