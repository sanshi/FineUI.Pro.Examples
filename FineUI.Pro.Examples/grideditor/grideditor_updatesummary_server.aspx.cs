...
{
    public partial class grideditor_updatesummary_server : PageBase
    {
        ...
        private void OutputSummaryData()
        {
            ...
            foreach (JObject mergedRow in Grid1.GetMergedData())
            {
                ...
                chineseTotal += values.Value<int>("ChineseScore");
                mathTotal += values.Value<int>("MathScore");
            }
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_updatesummary_getmergeddata";
