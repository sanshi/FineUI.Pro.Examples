...
{
    public partial class grideditor_selectfromwindow : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_selectfromwindow";
        ...
        protected void tbxEditorName_TriggerClick(object sender, EventArgs e)
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference("grideditor_selectfromwindow_iframe.aspx?rowid=" + selectedCell[0]));
            }
        }
        ...
        protected void Window1_Close(object sender, WindowCloseEventArgs e)
        {
            if (!String.IsNullOrEmpty(e.CloseArgument))
            {
                ...
                if (dataObj != null)
                {
                    ...
                    columnValues.Add("Gender", gender);
                    columnValues.Add("EntranceYear", entranceYear);
                    columnValues.Add("EntranceDate", entranceDate);
                    columnValues.Add("AtSchool", atSchool.ToString().ToLower());
                    columnValues.Add("Major", major);
