...
{
    public partial class grideditor_selectfromwindow_clientscript : PageBase
    {
        ...
        protected void tbxEditorName_TriggerClick(object sender, EventArgs e)
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference("grideditor_selectfromwindow_clientscript_iframe.aspx?rowid=" + selectedCell[0]));
            }
        }
    }
}
