<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_afteredit_rowexpander.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_afteredit_rowexpander" %>
            ...
            <Columns>
                ...
                <f:TemplateField ColumnID="expander" RenderAsRowExpander="true">
                    <ItemTemplate>
                        <div class="expander">
                            <p>
                                <strong>姓名：</strong><%# Eval("Name").ToString() %>
                            </p>
                            <p>
