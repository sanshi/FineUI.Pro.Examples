<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_editable_beforeedit.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_editable_beforeedit" %>
...
<head runat="server">
    <title></title>
    <style>
        .row-entranceyear-lte-2002 .f-grid-cell-text {
            opacity: .5;
