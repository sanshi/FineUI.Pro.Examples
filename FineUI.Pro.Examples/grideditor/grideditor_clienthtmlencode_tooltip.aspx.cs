...
{
    public partial class grideditor_clienthtmlencode_tooltip : PageBase
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            labResult.Text = String.Format("用户修改的数据：<pre>{0}</pre>", HttpUtility.HtmlEncode(Grid1.GetModifiedData().ToString(Newtonsoft.Json.Formatting.Indented)));
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "grideditor_clienthtmlencode_tooltip";
