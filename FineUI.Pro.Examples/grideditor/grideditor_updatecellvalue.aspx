<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_updatecellvalue.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_updatecellvalue" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（双击编辑）" EnableCollapse="false" runat="server"
            ...
            <Columns>
                ...
                <f:RenderField ColumnID="TotalScore" DataField="TotalScore" FieldType="Int" HeaderText="总成绩">
                    <Editor>
                        <f:NumberBox ID="NumberBox2" NoDecimal="true" NoNegative="true" Required="true" runat="server">
                        </f:NumberBox>
                    </Editor>
                </f:RenderField>
