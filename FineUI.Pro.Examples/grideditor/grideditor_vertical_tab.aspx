<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_vertical_tab.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_vertical_tab" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（单击编辑）" EnableCollapse="false"
            runat="server"
            AllowCellEditing="true" ClicksToEdit="1" TabVerticalNavigate="true">
            <Columns>
                <f:RowNumberField />
        ...
        <ul>
            ...
            <li>Tab键进入垂直方向的下一个单元格（如果单元格可编辑，则使其进入编辑状态）</li>
