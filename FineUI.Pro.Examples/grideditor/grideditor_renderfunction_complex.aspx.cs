...
{
    public partial class grideditor_renderfunction_complex : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_renderfunction_complex";
