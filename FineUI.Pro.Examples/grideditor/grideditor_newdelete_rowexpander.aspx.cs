...
{
    public partial class grideditor_newdelete_rowexpander : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_newdelete_rowexpander";
