<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_paging.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_paging" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" EnableCollapse="false"
            runat="server" AllowCellEditing="true" ClicksToEdit="1"
            DataIDField="Id" EnableCheckBoxSelect="true" IncludeMergedData="true"
    ...
    <script>
        ...
        function onNewClick(event) {
            ...
            grid1.pageIndex = Number.MAX_VALUE; // 确保跳转到最后一页
            grid1.addNewRecord({
                'Name': '',
                'Gender': 1,
                'EntranceYear': '2015',
