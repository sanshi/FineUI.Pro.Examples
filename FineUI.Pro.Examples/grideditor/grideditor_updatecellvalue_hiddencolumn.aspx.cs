...
{
    public partial class grideditor_updatecellvalue_hiddencolumn : PageBase
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "datatable_for_grideditor_updatecellvalue_hiddencolumn";
