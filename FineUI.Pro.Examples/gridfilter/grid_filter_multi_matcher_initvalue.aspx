<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_filter_multi_matcher_initvalue.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_filter_multi_matcher_initvalue" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            ...
            <Columns>
                ...
                <f:BoundField ColumnID="Name" DataField="Name" DataFormatString="{0}" HeaderText="姓名" EnableFilter="true">
                    <Filter EnableMultiConditions="true" MaxConditions="5" MatcherDefault="any">
                        <Operator>
        ...
        <br />
        <br />
        注：本例修改了姓名列对应过滤器的MaxConditions属性（最大条件数，默认为2）。
        <br />
        <br />
