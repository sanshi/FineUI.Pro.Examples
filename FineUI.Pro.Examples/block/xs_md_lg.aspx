<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xs_md_lg.aspx.cs" Inherits="FineUI.Pro.Examples.block.xs_md_lg" %>
...
<body class="f-body-darkerbg">
    <form id="form1" runat="server">
        ...
        <f:Panel IsFluid="true" runat="server"
            ...
            <Items>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="4" BlockLG="3"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="1">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="8" BlockLG="3"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="2">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="12" BlockMD="8" BlockLG="3"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="3">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="4" BlockLG="3"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="4">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="12" BlockLG="9"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="5">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="12" BlockMD="6" BlockLG="3"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="6">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="6" BlockLG="6"
                    runat="server" ShowBorder="true" ShowHeader="true" Title="7">
                </f:Panel>
                <f:Panel CssClass="custompanel" Block="6" BlockMD="12" BlockLG="6"
