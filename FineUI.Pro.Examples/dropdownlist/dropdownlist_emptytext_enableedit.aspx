<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_emptytext_enableedit.aspx.cs"
    Inherits="FineUI.Pro.Examples.dropdownlist.dropdownlist_emptytext_enableedit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ...
            <Items>
                <f:DropDownList runat="server" ID="DropDownList1" EnableEdit="true" AutoSelectFirstItem="false" EmptyText="请选择一项">
