<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="multiselect_tags.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownlist.multiselect_tags" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ShowBorder="true" Title="下拉列表（多选，初始为空）" ShowHeader="true">
            <Items>
                <f:DropDownList runat="server" ID="DropDownList1" EnableMultiSelect="true" MultiSelectMode="Tags" AutoSelectFirstItem="false">
