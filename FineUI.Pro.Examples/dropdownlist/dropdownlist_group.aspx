<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_group.aspx.cs"
    Inherits="FineUI.Pro.Examples.dropdownlist.dropdownlist_group" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ShowBorder="true" Title="列表项分组" ShowHeader="true">
            <Items>
