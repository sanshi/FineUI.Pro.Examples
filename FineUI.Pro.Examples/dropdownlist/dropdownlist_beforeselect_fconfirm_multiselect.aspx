<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_beforeselect_fconfirm_multiselect.aspx.cs"
    Inherits="FineUI.Pro.Examples.dropdownlist.dropdownlist_beforeselect_fconfirm_multiselect" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ShowBorder="true" Title="下拉列表（确认对话框，多选，F.confirm）" ShowHeader="true">
            <Items>
