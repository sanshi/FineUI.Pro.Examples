<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="multiselect_clearicon.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownlist.multiselect_clearicon" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false" Width="400px"
            ShowBorder="true" Title="下拉列表（多选）" ShowHeader="true">
            <Items>
                <f:DropDownList runat="server" ID="DropDownList1" EnableMultiSelect="true" AutoShowClearIcon="true">
