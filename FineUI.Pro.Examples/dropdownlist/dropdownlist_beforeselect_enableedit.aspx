<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_beforeselect_enableedit.aspx.cs"
    Inherits="FineUI.Pro.Examples.dropdownlist.dropdownlist_beforeselect_enableedit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ShowBorder="true" Title="下拉列表（确认对话框，window.confirm）" ShowHeader="true">
            <Items>
