<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="calendar.aspx.cs" Inherits="FineUI.Pro.Examples.calendar.calendar" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Calendar runat="server" EnableDateSelectEvent="true" DateFormatString="yyyy/MM/dd"
            OnDateSelect="Calendar1_DateSelect" ID="Calendar1" ShowTodayButton="true">
        </f:Calendar>
        <br />
        <br />
