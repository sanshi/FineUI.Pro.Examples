<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridrowgroup.aspx.cs" Inherits="FineUI.Pro.Examples.gridrowgroup.gridrowgroup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" Height="500px" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            DataIDField="Id" DataTextField="Name" EnableRowGroup="true" DataRowGroupField="EntranceYear" EnableCheckBoxSelect="true">
            <Columns>
                <f:RowNumberField />
        ...
        <br />
        <br />
        注：表格启用行分组后不支持单元格编辑、行扩展列、树表格、列锁定和内存分页。
    </form>
