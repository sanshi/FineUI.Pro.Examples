<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridrowgroup_expanded.aspx.cs" Inherits="FineUI.Pro.Examples.gridrowgroup.gridrowgroup_expanded" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" Height="500px" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            DataIDField="Id" DataTextField="Name" EnableRowGroup="true" DataRowGroupField="EntranceYear" ExpandAllRowGroups="false">
            <Columns>
                <f:RowNumberField />
