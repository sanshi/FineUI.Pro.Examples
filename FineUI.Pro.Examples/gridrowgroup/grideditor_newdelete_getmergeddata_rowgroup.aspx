<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grideditor_newdelete_getmergeddata_rowgroup.aspx.cs"
    Inherits="FineUI.Pro.Examples.grideditor.grideditor_newdelete_getmergeddata_rowgroup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（双击编辑）" EnableCollapse="false" runat="server" AllowCellEditing="true"
            ClicksToEdit="2" DataIDField="Id" EnableCheckBoxSelect="true" IncludeMergedData="true" EnableRowGroup="true" DataRowGroupField="EntranceYear">
            <Toolbars>
