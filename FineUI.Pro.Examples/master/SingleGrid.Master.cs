...
namespace FineUI.Pro.Examples.master
{
    public partial class SingleGrid : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            Page.Grid.PageIndexChanged += grid_PageIndexChangedd;
        ...
        {
            if (Page.Grid.SelectedRowIDArray.Length == 0)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void grid_PageIndexChangedd(object sender, GridPageEventArgs e)
        {
