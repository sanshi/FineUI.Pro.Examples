<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tooltip.aspx.cs" Inherits="FineUI.Pro.Examples.form.tooltip" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Button ID="btnTooltip" Text="点击改变最后一个图片的提示信息" OnClick="btnTooltip_Click" runat="server">
        </f:Button>
