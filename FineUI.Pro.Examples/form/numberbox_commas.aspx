<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="numberbox_commas.aspx.cs" Inherits="FineUI.Pro.Examples.form.numberbox_commas" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" LabelAlign="Top" EnableCollapse="false"
            ...
            <Items>
                <f:NumberBox Label="小数" ID="NumberBox1" runat="server" Text="-12345.6789" EnableCommas="true"
                    Required="true" ShowRedStar="true" DecimalPrecision="2" />
                <f:NumberBox Label="正整数" ID="NumberBox2" NoDecimal="true" NoNegative="true" Text="987654321" EnableCommas="true" ShowTrigger="false" runat="server" />
