...
namespace FineUI.Pro.Examples.form
{
    public partial class checkboxlist_update : PageBase
    {
        ...
        {
            ShowNotify("列表一的选中项：" + GetCheckedValuesString(CheckBoxList1.SelectedValueArray));
        }
        ...
        {
            ShowNotify("列表二的选中项：" + GetCheckedValuesString(CheckBoxList2.SelectedValueArray));
        }
        ...
        {
            ShowNotify("列表三的选中项：" + GetCheckedValuesString(CheckBoxList3.SelectedValueArray));
        }
        ...
        {
            ShowNotify("列表四的选中项：" + GetCheckedValuesString(CheckBoxList4.SelectedValueArray));
        }
