...
namespace FineUI.Pro.Examples.form
{
    public partial class radiobuttonlist_update : PageBase
    {
        ...
        {
            ShowNotify("列表一的选中项：" + GetCheckedValuesString(RadioButtonList1.SelectedValue));
        }
        ...
        {
            ShowNotify("列表二的选中项：" + GetCheckedValuesString(RadioButtonList2.SelectedValue));
        }
        ...
        {
            ShowNotify("列表三的选中项：" + GetCheckedValuesString(RadioButtonList3.SelectedValue));
        }
        ...
        {
            ShowNotify("列表四的选中项：" + GetCheckedValuesString(RadioButtonList4.SelectedValue));
        }
