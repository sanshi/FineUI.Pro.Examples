<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form_attributes.aspx.cs" Inherits="FineUI.Pro.Examples.form.form_attributes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Label ID="Label1" Text="提示信息（ToolTip属性）" ToolTip="通过ToolTip属性设置的提示信息" runat="server">
        </f:Label>
        <br />
        <f:Button ID="btnChangeTip1" Text="改变文本的提示信息" runat="server" OnClick="btnChangeTip1_Click" />
        <br />
        <br />
        <br />
        <f:Label ID="Label2" Text="提示信息（Attributes属性）" runat="server">
        </f:Label>
        <br />
        <f:Button ID="btnChangeTip2" Text="改变文本的提示信息" runat="server" OnClick="btnChangeTip2_Click" />
        <br />
        <br />
        <br />
        通过 Attributes 属性设置图片的 usemap 属性：
        <br />
        <f:Image runat="server" ID="imgChina" ImageUrl="~/res/images/china.gif">
        </f:Image>
        <br />
        图片来源：<a href="http://www.sbsm.gov.cn/article/zxbs/dtfw/" target="_blank">http://www.sbsm.gov.cn/article/zxbs/dtfw/</a>
    ...
    <script>
        ...
        function select(provinceName) {
            F.notify({
                message: '点击的省份：' + provinceName,
                messageIcon: 'information',
                displayMilliseconds: 2 * 1000,
                header: false,
                positionX: 'center',
                positionY: 'center'
            });
