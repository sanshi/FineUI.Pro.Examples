<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="button_buttongroup.aspx.cs" Inherits="FineUI.Pro.Examples.button.button_buttongroup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:ButtonGroup ID="ButtonGroup3" runat="server">
