<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="button.aspx.cs" Inherits="FineUI.Pro.Examples.button.button" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Button ID="btnPrimary" Text="主按钮" ButtonColor="Primary" CssClass="marginr" runat="server" />
        <f:Button ID="btnSuccess" Text="成功按钮" ButtonColor="Success" CssClass="marginr" runat="server" />
        <f:Button ID="btnDanger" Text="危险按钮" ButtonColor="Danger" CssClass="marginr" runat="server" />
        <f:Button ID="btnWarning" Text="警告按钮" ButtonColor="Warning" CssClass="marginr" runat="server" />
        <f:Button ID="btnInfo" Text="信息按钮" ButtonColor="Info" runat="server" />
        <br />
        <br />
