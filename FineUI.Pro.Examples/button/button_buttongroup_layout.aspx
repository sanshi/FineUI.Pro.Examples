<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="button_buttongroup_layout.aspx.cs" Inherits="FineUI.Pro.Examples.button.button_buttongroup_layout" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" Margin="24px" ShowBorder="false" ShowHeader="false" CssClass="f-widget-content" AutoScroll="true"
            Layout="VBox" BoxConfigAlign="Start" BoxConfigChildMargin="0 0 10px 0" BodyPadding="10px" runat="server">
            <Items>
                <f:ButtonGroup runat="server" Layout="HBox" Width="600px">
                ...
                <f:ButtonGroup runat="server" Layout="VBox" Vertical="true" Width="200px" MarginTop="50px">
                ...
                <f:ButtonGroup runat="server" Layout="VBox" Vertical="true" Width="200px">
