<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="button_menu.aspx.cs" Inherits="FineUI.Pro.Examples.button.button_menu" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Button ID="btnMenu" Text="中国科学技术大学" IconFont="_Bicycle" runat="server">
            <Menu runat="server">
        ...
        <br />
        <br />
        <f:Button ID="Button1" Text="中国科学技术大学（动态创建下拉菜单）" Icon="Map" runat="server">
        </f:Button>
        <br />
        <br />
    </form>
