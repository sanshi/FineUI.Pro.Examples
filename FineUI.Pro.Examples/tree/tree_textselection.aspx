<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_textselection.aspx.cs" Inherits="FineUI.Pro.Examples.tree.tree_textselection" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" IsFluid="true" ShowHeader="true" Title="树控件（可以选择文字）" EnableCollapse="false" EnableTextSelection="true"
            runat="server">
            <Nodes>
