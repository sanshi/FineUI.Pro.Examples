<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_noicon.aspx.cs" Inherits="FineUI.Pro.Examples.tree.tree_noicon" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" IsFluid="true" ShowHeader="true" Title="树控件（隐藏节点图标）" EnableCollapse="false" EnableIcons="false"
            runat="server">
            <Nodes>
