<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_singleexpand.aspx.cs" Inherits="FineUI.Pro.Examples.tree.tree_singleexpand" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" IsFluid="true" ShowHeader="true" Title="树控件（EnableSingleExpand）"
            EnableCollapse="false" EnableSingleClickExpand="false" EnableSingleExpand="true"
            runat="server">
            <Nodes>
