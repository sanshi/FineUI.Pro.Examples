<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tree_checkbox_onlyleafcheck.aspx.cs" Inherits="FineUI.Pro.Examples.tree.checkbox.tree_checkbox_onlyleafcheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Tree ID="Tree1" IsFluid="true" ShowHeader="true" EnableCollapse="false"
            Title="树控件" runat="server" EnableCheckBox="true" OnlyLeafCheck="true">
            <Nodes>
