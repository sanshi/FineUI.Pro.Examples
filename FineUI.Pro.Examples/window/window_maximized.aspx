<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_maximized.aspx.cs" Inherits="FineUI.Pro.Examples.window.window_maximized" %>
...
<head runat="server">
    ...
    <%--<style>
        /* 最大化状态时也显示折叠按钮 */
        .f-window.f-window-maximized .f-tool.f-tool-toggle {
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Window ID="Window1" Width="650px" Height="300px" IconFont="_Tag" Title="窗体"
            EnableCollapse="false" runat="server" EnableResize="true"
            IsModal="false" AutoScroll="true" BodyPadding="10px"
            EnableMaximize="true" Maximized="true">
            <Content>
                <p>
    ...
    <script>
        ...
        // 显示窗体，指定大小为 900px * 450px
        function onShowWindow900Click(event) {
            F(Window1ClientID).show(900, 450);
        }

        // 显示窗体，指定一个非常大的高度，这样无论外部页面的高度如何，弹出窗体的高度都会占满整个页面
        function onShowWindowLargeHeightClick(event) {
            F(Window1ClientID).show(900, 10000);
        }
