<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_form.aspx.cs"
    Inherits="FineUI.Pro.Examples.window.window_form" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window2" Width="650px" Height="300px" Icon="TagBlue" Title="窗体"
            EnableMaximize="true"
            EnableCollapse="false" runat="server" EnableResize="true" BodyPadding="10px" Layout="Fit"
            IsModal="false">
            <Items>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar3" Position="Top" runat="server">
                    <Items>
                        ...
                        <f:Button ID="Button1" runat="server" Text="工具栏按钮" OnClick="Button1_Click">
                        </f:Button>
                    </Items>
                </f:Toolbar>
