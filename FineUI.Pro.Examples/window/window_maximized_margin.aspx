<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_maximized_margin.aspx.cs" Inherits="FineUI.Pro.Examples.window.window_maximized_margin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Window ID="Window1" Width="650px" Height="300px" Icon="TagBlue" Title="窗体（最大化时外边距为 50px）"
