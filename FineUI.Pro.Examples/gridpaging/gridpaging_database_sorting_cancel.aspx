<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridpaging_database_sorting_cancel.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridpaging.gridpaging_database_sorting_cancel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" PageSize="5" ShowBorder="true" ShowHeader="true"
            ...
            AllowSorting="true" SortField="Name" SortDirection="ASC" SortingCancel="true" SortingToolTip="true"
            OnSort="Grid1_Sort">
            <Columns>
                <f:RowNumberField />
