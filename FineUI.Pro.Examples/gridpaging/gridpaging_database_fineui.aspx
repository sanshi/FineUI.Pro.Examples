<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridpaging_database_fineui.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridpaging.gridpaging_database_fineui" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" Title="表格" IsFluid="true" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                ...
                <f:HyperLinkField ColumnID="Major" HeaderText="所学专业" DataTextField="Major"
