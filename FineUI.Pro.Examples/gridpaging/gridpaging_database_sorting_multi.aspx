<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridpaging_database_sorting_multi.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridpaging.gridpaging_database_sorting_multi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" PageSize="5" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                <f:RowNumberField />
                <f:BoundField Width="150px" DataField="Name" SortField="Name" DataFormatString="{0}"
                    HeaderText="姓名" />
