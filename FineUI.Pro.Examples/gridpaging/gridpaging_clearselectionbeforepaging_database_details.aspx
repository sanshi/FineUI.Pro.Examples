<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridpaging_clearselectionbeforepaging_database_details.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridpaging.gridpaging_clearselectionbeforepaging_database_details" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" Title="表格（跨页选中行）" EnableCollapse="false" PageSize="5" ShowBorder="true" ShowHeader="true"
            ...
            DataKeyNames="Id,Name,Major" OnPageIndexChanged="Grid1_PageIndexChanged" DataTextField="Name" KeepCurrentSelection="true"
        ...
        <ul>
            <li>注意设置属性：
                <ul>
                    ...
                    <li>ClearSelectionBeforeBinding=false：数据绑定前清空选中项（服务端，数据库分页事件中需要重新绑定数据）</li>
