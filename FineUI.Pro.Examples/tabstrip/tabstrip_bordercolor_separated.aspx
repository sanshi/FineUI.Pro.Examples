<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_bordercolor_separated.aspx.cs" Inherits="FineUI.Pro.Examples.tabstrip.tabstrip_bordercolor_separated" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip4" IsFluid="true" Height="150px" ShowBorder="true" TabBorderColor="true" TabSeparated="true" ActiveTabIndex="0"
            runat="server">
            <Tabs>
        ...
        <br />
        <f:TabStrip ID="TabStrip5" IsFluid="true" Height="150px" ShowBorder="true" TabAlign="Center" TabBorderColor="true" TabSeparated="true" ActiveTabIndex="1"
            runat="server">
            <Tabs>
        ...
        <br />
        <f:TabStrip ID="TabStrip6" IsFluid="true" Height="150px" ShowBorder="true" TabAlign="Right" TabBorderColor="true" TabSeparated="true" ActiveTabIndex="2"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip1" IsFluid="true" Height="150px" TabFill="true" TabBorderColor="true" TabSeparated="true" ShowBorder="true" ActiveTabIndex="0"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip2" IsFluid="true" Height="150px" TabFill="true" TabSpace="0" TabBorderColor="true" TabSeparated="true" ShowBorder="true" ActiveTabIndex="1"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip3" IsFluid="true" Height="150px" TabFill="true" TabSpace="-1" TabBorderColor="true" TabSeparated="true" ShowBorder="true" ActiveTabIndex="2"
            runat="server">
            <Tabs>
