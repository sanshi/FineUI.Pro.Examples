<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_bordercolor.aspx.cs" Inherits="FineUI.Pro.Examples.tabstrip.tabstrip_bordercolor" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip4" IsFluid="true" Height="150px" ShowBorder="true" TabBorderColor="true" ActiveTabIndex="0"
            runat="server">
            <Tabs>
        ...
        <br />
        <f:TabStrip ID="TabStrip5" IsFluid="true" Height="150px" ShowBorder="true" TabAlign="Center" TabBorderColor="true" ActiveTabIndex="1"
            runat="server">
            <Tabs>
        ...
        <br />
        <f:TabStrip ID="TabStrip6" IsFluid="true" Height="150px" ShowBorder="true" TabAlign="Right" TabBorderColor="true" ActiveTabIndex="2"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip1" IsFluid="true" Height="150px" TabFill="true" TabBorderColor="true" ShowBorder="true" ActiveTabIndex="0"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip2" IsFluid="true" Height="150px" TabFill="true" TabSpace="0" TabBorderColor="true" ShowBorder="true" ActiveTabIndex="1"
            runat="server">
            <Tabs>
        ...
        <br />
        <br />
        <f:TabStrip ID="TabStrip3" IsFluid="true" Height="150px" TabFill="true" TabSpace="-1" TabBorderColor="true" ShowBorder="true" ActiveTabIndex="2"
            runat="server">
            <Tabs>
