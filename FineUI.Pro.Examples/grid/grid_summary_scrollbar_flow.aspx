<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_summary_scrollbar_flow.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_summary_scrollbar_flow" %>
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" Height="350px" Width="900px"
            ...
            <Columns>
                ...
                <f:HyperLinkField HeaderText="所学专业" ColumnID="Major" DataToolTipField="Major" DataTextField="Major"
                    ...
                    UrlEncode="true" Target="_blank" Width="500px" />
