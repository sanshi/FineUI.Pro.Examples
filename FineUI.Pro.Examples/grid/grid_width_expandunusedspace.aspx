<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_width_expandunusedspace.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_width_expandunusedspace" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" ShowBorder="true" Margin="24px" ShowHeader="true" Title="表格（[个人简介]占据空余空间100%）(改变页面大小来观察每列宽度的变化)"
            runat="server">
            <Columns>
                <f:RowNumberField />
