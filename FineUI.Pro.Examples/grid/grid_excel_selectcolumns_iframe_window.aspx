<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="grid_excel_selectcolumns_iframe_window.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_excel_selectcolumns_iframe_window" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="true" ShowHeader="false" Layout="Anchor"
            BodyPadding="10px">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <f:Button ID="btnClose" Text="取消" runat="server" Icon="SystemClose" ClickHandler="onCloseClick">
                        </f:Button>
