<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_checkall_autohide.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_checkall_autohide" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" ShowBorder="true" ShowHeader="true"
            runat="server" EnableCheckBoxSelect="true" DataKeyNames="Id,Name" CheckBoxSelectAutoHide="true">
            <Columns>
                <%--<f:RowNumberField />--%>
