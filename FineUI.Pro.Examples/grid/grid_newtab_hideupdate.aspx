<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_newtab_hideupdate.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_newtab_hideupdate" %>
...
<body>
    ...
    <script>
        ...
        function getNewWindowUrl() {
            return F.resolveUrl('/grid/grid_newtab_hideupdate_window.aspx?parenttabid=' + parent.getActiveTabId());
        }


        function getEditWindowUrl(id, name) {
            return F.resolveUrl('/grid/grid_newtab_hideupdate_window.aspx?id=' + id + '&name=' + name + '&parenttabid=' + parent.getActiveTabId());
        }
        ...
        function updatePage(param1) {
            F.customEvent('UpdatePage', param1);
        }
