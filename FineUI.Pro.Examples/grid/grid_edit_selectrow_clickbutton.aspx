<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_edit_selectrow_clickbutton.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_edit_selectrow_clickbutton" %>
...
<body>
            ...
            <Toolbars>
                <f:Toolbar runat="server">
                    <Items>
                        ...
                        <f:Button runat="server" ID="btnSubmit" Text="保存数据" OnClick="btnSubmit_Click"></f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
            <Columns>
    ...
    <ul>
        ...
        <li>在表格最后一行选中时，按 Enter 或者 Tab 键自动点击 [保存数据] 按钮</li>
        <li>提交后弹出对话框，按 Enter 键或者 ESC 键关闭弹出框</li>
    </ul>
        <br />
    ...
    <script type="text/javascript">
        ...
        var btnSubmintID = '<%=btnSubmit.ClientID%>';
