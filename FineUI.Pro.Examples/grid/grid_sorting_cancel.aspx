<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_sorting_cancel.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_sorting_cancel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false"
            AllowSorting="true" SortField="Gender" SortDirection="ASC" SortingCancel="true" SortingToolTip="true"
