<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_checkall_keepcurrentselection_deselect.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_checkall_keepcurrentselection_deselect" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        注：开启了DeselectOnRowClick属性，点击已选中的行会取消选中。
        <br />
        <br />
