<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_summary_multiline.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_summary_multiline" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" Height="450px"
            ...
            EnableSummary="true" SummaryPosition="Bottom" SummaryRowCount="2">
            <Columns>
                <f:RowNumberField />
                ...
                <f:HyperLinkField HeaderText="所学专业" ColumnID="Major" DataToolTipField="Major" DataTextField="Major"
                    ...
                    UrlEncode="true" Target="_blank" MinWidth="150px" ExpandUnusedSpace="true" />
