...
{
    public partial class grid_style_cellattributes : PageBase
    {
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            {
                e.SetCellAttribute("cEntranceYear", "data-color", "color3");
                //e.CellAttributes[cEntranceYear.ColumnIndex]["data-color"] = "color3";
            }
            ...
            if (gender == 1)
            {
                e.SetCellAttribute("cGender", "data-color", "color1");
