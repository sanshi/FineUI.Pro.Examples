<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_sorting_multi.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_sorting_multi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false"
            AllowSorting="true" SortingCancel="true" SortingToolTip="true" SortingMulti="true" SortFieldArray="EntranceYear,DESC,Gender,ASC"
