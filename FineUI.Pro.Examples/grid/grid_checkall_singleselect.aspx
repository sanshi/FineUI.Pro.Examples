<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_checkall_singleselect.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_checkall_singleselect" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格（只能单选）"  EnableCollapse="false" ShowBorder="true" ShowHeader="true"
            runat="server" EnableCheckBoxSelect="true" DataKeyNames="Id,Name" EnableMultiSelect="false">
            <Columns>
                <f:RowNumberField />
