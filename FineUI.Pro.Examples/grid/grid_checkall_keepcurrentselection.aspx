<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_checkall_keepcurrentselection.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_checkall_keepcurrentselection" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                ...
                <f:LinkButtonField Width="60px" TextAlign="Center" ColumnID="Deleteit" ConfirmText="确定要删除本行？" ConfirmTarget="Top" CommandName="Action3" IconFont="_Close" />
            </Columns>
        </f:Grid>
        <br />
