<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_summary_renderer.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_summary_renderer" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" Height="350px"
            ...
            EnableSummary="true" SummaryPosition="Flow" EnableColumnLines="false">
            <Columns>
                <f:RowNumberField />
