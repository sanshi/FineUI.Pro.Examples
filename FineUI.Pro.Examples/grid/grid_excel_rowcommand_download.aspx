<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_excel_rowcommand_download.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_excel_rowcommand_download" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                ...
                <f:LinkButtonField ColumnID="Action2" EnableAjax="false" CommandName="Action2" Text="下载" />
            </Columns>
        </f:Grid>
        <br />
