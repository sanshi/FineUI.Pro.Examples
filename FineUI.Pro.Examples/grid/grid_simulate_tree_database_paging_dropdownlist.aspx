<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_simulate_tree_database_paging_dropdownlist.aspx.cs"
    Inherits="FineUI.Pro.Examples.grid.grid_simulate_tree_database_paging_dropdownlist" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" ShowBorder="true" ShowHeader="true" runat="server"
            EnableCheckBoxSelect="true" AllowPaging="true" IsDatabasePaging="true" PageSize="1" Height="500px" OnPageIndexChanged="Grid1_PageIndexChanged"
            ...
            <PageItems>
                <f:DropDownList runat="server" ID="ddlSheng" Width="120px" OnSelectedIndexChanged="ddlSheng_SelectedIndexChanged">
                </f:DropDownList>
            </PageItems>
        </f:Grid>
    </form>
