<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bigdata_dataurl_5000.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridbigdata.bigdata_dataurl_5000" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（网址数据源，5000行）" EnableCollapse="false" Height="500px" EnableCheckBoxSelect="true"
            runat="server" DataIDField="Id" DataUrl="~/gridbigdata/data.ashx?total=5000&type=simple"
