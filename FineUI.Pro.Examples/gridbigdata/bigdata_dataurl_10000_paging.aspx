<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bigdata_dataurl_10000_paging.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridbigdata.bigdata_dataurl_10000_paging" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（网址数据源，10000行）" EnableCollapse="false" Height="500px" EnableCheckBoxSelect="true"
            ...
            EnableBigData="true" FixedRowHeight="true" AllowPaging="true" IsDatabasePaging="false" PageSize="300" 
