<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bigdata_dataurl_10000_paging_database.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridbigdata.bigdata_dataurl_10000_paging_database" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title></title>
    <meta name="sourcefiles" content="~/gridbigdata/data_paging_database.ashx" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（网址数据源，10000行）" EnableCollapse="false" Height="500px" EnableCheckBoxSelect="true"
            runat="server" DataIDField="Id" DataUrl="~/gridbigdata/data_paging_database.ashx?total=10000"
            EnableBigData="true" FixedRowHeight="true" AllowPaging="true" IsDatabasePaging="true" PageSize="120" 
            EnableBigDataRowTip="false" PagingToolbarVisible="true">
            <Columns>
