<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bigdata_dataurl_1000_summary.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridbigdata.bigdata_dataurl_1000_summary" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格（网址数据源，1000行）" EnableCollapse="false" Height="500px" EnableCheckBoxSelect="true"
            ...
            EnableBigData="true" FixedRowHeight="true" EnableSummary="true" SummaryPosition="Bottom"
            EnableBigDataRowTip="true" PagingToolbarVisible="false">
            <Columns>
                ...
                <f:RenderField ColumnID="EntranceYear" DataField="EntranceYear" FieldType="Int"
                    HeaderText="入学年份" SummaryType="Sum">
                </f:RenderField>
