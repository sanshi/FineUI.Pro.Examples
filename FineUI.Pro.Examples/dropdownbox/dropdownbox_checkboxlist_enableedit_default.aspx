<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_checkboxlist_enableedit_default.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_checkboxlist_enableedit_default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ...
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" DataControlID="RadioButtonList1" EnableMultiSelect="true" EnableEdit="true">
                    <PopPanel>
