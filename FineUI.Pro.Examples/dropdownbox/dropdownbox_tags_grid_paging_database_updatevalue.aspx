<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_tags_grid_paging_database_updatevalue.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_tags_grid_paging_database_updatevalue" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ...
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" EmptyText="请从下拉表格中选择" EnableMultiSelect="true" MatchFieldWidth="true"
                    Values="115,105" Texts="董国,吴颖颖" MultiSelectMode="Tags">
                    <PopPanel>
                        <f:Grid ID="Grid1" Height="300px" Hidden="true"
                ...
                <f:Panel CssClass="f-field" ShowBorder="false" ShowHeader="false" runat="server">
                    <Items>
                        <f:Button ID="btnUpdateValue" CssClass="marginr" Text="更新下拉框的值为[张娟娟,叶鹏]" runat="server" OnClick="btnUpdateValue_Click">
                        </f:Button>
                        <f:Button ID="btnClearValue" CssClass="marginr" Text="清空下拉框的值" runat="server" OnClick="btnClearValue_Click">
                        </f:Button>
