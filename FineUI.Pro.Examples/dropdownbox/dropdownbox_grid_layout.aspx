<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_grid_layout.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_grid_layout" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false" ShowBorder="true" Title="下拉表格（复杂布局）"
            ShowHeader="true">
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" EmptyText="请从下拉表格中选择" DataControlID="Grid1" EnableMultiSelect="true" MatchFieldWidth="false">
                    <PopPanel>
                        <f:Panel ID="Panel7" runat="server" BodyPadding="10px" Width="650px" Height="300px" Hidden="true" ShowBorder="true" ShowHeader="false"
                            ...
                            <Items>
                                <f:Form ShowBorder="false" ShowHeader="false" runat="server" RemoveLastFieldsMargin="true">
                                    <Rows>
                                        <f:FormRow>
                                            <Items>
                                ...
                                <f:Grid ID="Grid1" BoxFlex="1" DataIDField="Id" DataTextField="Name" EnableMultiSelect="true" KeepCurrentSelection="true"
                                    PageSize="10" ShowBorder="true" ShowHeader="false" AllowPaging="true" IsDatabasePaging="true"
                                    OnPageIndexChanged="Grid1_PageIndexChanged" runat="server" EnableCheckBoxSelect="true" AllowSorting="true" SortField="Name"
