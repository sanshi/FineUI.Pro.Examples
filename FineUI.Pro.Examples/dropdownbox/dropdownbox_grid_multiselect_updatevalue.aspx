<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_grid_multiselect_updatevalue.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_grid_multiselect_updatevalue" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ...
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" EmptyText="请从下拉表格中选择"
                    EnableMultiSelect="true" MatchFieldWidth="false" Values="105,108">
                    <PopPanel>
                ...
                <f:Button ID="btnUpdateValue" Text="更新下拉框的值为[陈飞,黄婷婷,张三石]" CssClass="marginr" runat="server" OnClick="btnUpdateValue_Click">
                </f:Button>
