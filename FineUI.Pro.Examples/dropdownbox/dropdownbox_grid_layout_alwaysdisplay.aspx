<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_grid_layout_alwaysdisplay.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_grid_layout_alwaysdisplay" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false" ShowBorder="true" Title="始终显示弹出面板"
            ShowHeader="true">
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" EmptyText="请从下面表格中选择" DataControlID="Grid1" PopPanelID="Panel7" AlwaysDisplayPopPanel="true"
                    EnableMultiSelect="true" MatchFieldWidth="false" AutoShowClearIcon="true">
                </f:DropDownBox>
