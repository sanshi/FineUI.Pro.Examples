<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownbox_tags_grid_multiselect_enableedit.aspx.cs" Inherits="FineUI.Pro.Examples.dropdownbox.dropdownbox_tags_grid_multiselect_enableedit" %>
        ...
        <f:SimpleForm ID="SimpleForm1" IsFluid="true" BodyPadding="10px" runat="server" EnableCollapse="false"
            ...
            <Items>
                <f:DropDownBox runat="server" ID="DropDownBox1" EmptyText="请从下拉表格中选择"
                    EnableMultiSelect="true" MultiSelectMode="Tags" MatchFieldWidth="false" Values="105,108" EnableEdit="true">
                    <PopPanel>
