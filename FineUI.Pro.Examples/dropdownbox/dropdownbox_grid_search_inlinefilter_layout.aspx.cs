...
{
    public partial class dropdownbox_grid_search_inlinefilter_layout : PageBase
    {
        ...
        private DataTable GetSource()
        {
            ...
            // 表格工具栏中的下拉列表过滤项
            if (!String.IsNullOrEmpty(ddlAtSchool.SelectedValue) && ddlAtSchool.SelectedValue != "-1")
            {
                filters.Add(String.Format("AtSchool = {0}", ddlAtSchool.SelectedValue));
            }
            
            // 表头菜单的过滤项
            JArray filteredData = Grid1.FilteredData;
