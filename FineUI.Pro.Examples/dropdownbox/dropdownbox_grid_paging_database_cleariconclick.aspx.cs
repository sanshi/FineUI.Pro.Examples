...
{
    public partial class dropdownbox_grid_paging_database_cleariconclick : PageBase
    {
        ...
        protected void DropDownBox1_ClearIconClick(object sender, EventArgs e)
        {
            labResult.Text = "你点击了清空图标";
        }
