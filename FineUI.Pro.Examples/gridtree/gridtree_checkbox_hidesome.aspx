<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_checkbox_hidesome.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.treegrid_checkbox_hidesome" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        注：本树表格默认隐藏 [basic] 和 [res] 两个目录的复选框。
    </form>
