<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_lazyload_templatefield.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.gridtree_lazyload_templatefield" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="树表格" runat="server" EnableCollapse="false"
            ...
            OnRowDataBound="Grid1_RowDataBound" OnRowLazyLoad="Grid1_RowLazyLoad">
            <Columns>
                <f:RowNumberField />
                ...
                <f:TemplateField Width="180px" HeaderText="模板列（名称）">
                    <ItemTemplate>
