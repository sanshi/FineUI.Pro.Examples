<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_celleditor_lockcolumn.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.gridtree_celleditor_lockcolumn" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="树表格" runat="server" EnableCollapse="false"
            ...
            AllowCellEditing="true" ClicksToEdit="1" EnableCheckBoxSelect="true" AllowColumnLocking="true" TabVerticalNavigate="false">
            <Columns>
                <f:RowNumberField />
                <f:RenderField EnableLock="true" ColumnID="Name" Width="550px" DataField="Name" HeaderText="名称">
                    <Editor>
                        <f:TextBox ID="tbxName" Required="true" runat="server">
                        </f:TextBox>
                    </Editor>
                </f:RenderField>
                <f:RenderField EnableLock="true" Width="150px" ColumnID="Type" DataField="Type" HeaderText="类型"
                ...
                <f:RenderField EnableLock="true" ColumnID="Size" DataField="Size" HeaderText="大小" FieldType="Int">
                    <Editor>
                        <f:NumberBox ID="tbxSize" NoDecimal="true" NoNegative="true" MinValue="0" runat="server">
                        </f:NumberBox>
                    </Editor>
                </f:RenderField>
                <f:RenderField EnableLock="true" Locked="true" Width="150px" ColumnID="ModifyDate" DataField="ModifyDate" HeaderText="修改日期" FieldType="Date"
