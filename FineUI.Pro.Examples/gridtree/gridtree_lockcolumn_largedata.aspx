<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_lockcolumn_largedata.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.gridtree_lockcolumn_largedata" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="树表格（3500个节点）" runat="server" EnableCollapse="false"
            EnableTree="true" TreeColumn="Name" DataIDField="Id" DataParentIDField="ParentId"
            AllowColumnLocking="true">
            <Columns>
                <f:RowNumberField EnableTreeNumber="false" Width="80px" />
