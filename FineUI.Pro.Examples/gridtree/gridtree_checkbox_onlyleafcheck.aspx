<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_checkbox_onlyleafcheck.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.gridtree_checkbox_onlyleafcheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="树表格" runat="server" EnableCollapse="false"
            EnableTree="true" TreeColumn="Name" DataIDField="Id" DataParentIDField="ParentId" DataTextField="Name" TreeCheckBox="true" TreeOnlyLeafCheck="true">
            <Columns>
                <f:RowNumberField />
