<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gridtree_checkbox_cascade_initvalue.aspx.cs" Inherits="FineUI.Pro.Examples.gridtree.treegrid_checkbox_cascade_initvalue" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="树表格" runat="server" EnableCollapse="false"
            EnableTree="true" TreeColumn="Name" DataIDField="Id" DataParentIDField="ParentId" DataTextField="Name" TreeCheckBox="true" TreeCascadeCheck="true"
        ...
        <br />
        <br />
        注：本树表格默认选中 [common / menu.xml] 的复选框。
    </form>
