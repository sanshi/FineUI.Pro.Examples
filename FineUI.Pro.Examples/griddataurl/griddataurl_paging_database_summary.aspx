<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="griddataurl_paging_database_summary.aspx.cs"
    Inherits="FineUI.Pro.Examples.griddataurl.griddataurl_paging_database_summary" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title></title>
    <meta name="sourcefiles" content="~/griddataurl/griddataurl_paging_database_summary.ashx" />
    <style>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" EnableCollapse="false" Height="350px" EnableCheckBoxSelect="true"
            runat="server" DataIDField="Id" DataUrl="~/griddataurl/griddataurl_paging_database_summary.ashx" 
