<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_500_lockcolumn_rowheight_delayrender.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridrowheight.grid_500_lockcolumn_rowheight_delayrender" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Height="500px" Title="500行（行高固定，列锁定，延迟渲染）"
