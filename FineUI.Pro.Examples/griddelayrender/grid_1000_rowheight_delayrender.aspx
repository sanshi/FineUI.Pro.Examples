<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_1000_rowheight_delayrender.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridrowheight.grid_1000_rowheight_delayrender" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid DataIDField="Id" ID="Grid1" IsFluid="true" Height="500px" ShowBorder="true" ShowHeader="true" Title="1000行（行高固定，延迟渲染）"
