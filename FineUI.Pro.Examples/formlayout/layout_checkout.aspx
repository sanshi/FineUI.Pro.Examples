<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="layout_checkout.aspx.cs"
    Inherits="FineUI.Pro.Examples.form.layout_checkout" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Window ID="Window1" runat="server" Title="账单信息" IsModal="false" EnableClose="false" EnableResize="true" Width="650px" BodyPadding="10px"
            AutoScroll="true">
            <Items>
                <f:Form ID="Form1" LabelAlign="Right" MessageTarget="Qtip" ShowBorder="false" ShowHeader="false" runat="server">
                    <Items>
                        <f:GroupPanel ID="GroupPanel1" Layout="Anchor" Title="联系人信息" runat="server">
                            <Items>
                                <f:Panel ID="Panel2" Layout="HBox" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        <f:Label ID="Label1" runat="server" ShowRedStar="true" Label="姓名"></f:Label>
                                        <f:TextBox ID="TextBox2" ShowLabel="false" CssClass="marginr" Required="true" ShowRedStar="true" BoxFlex="2"
                                            runat="server">
                                        </f:TextBox>
                                ...
                                <f:Panel ID="Panel1" Layout="HBox" BoxConfigAlign="Stretch" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        <f:TextBox ID="TextBox1" Required="true" ShowRedStar="true" Label="电子邮箱" RegexPattern="EMAIL" RegexMessage="请输入有效的邮箱地址"
                                            BoxFlex="1" runat="server">
                                        </f:TextBox>
                                        <f:TextBox ID="TextBox6" Label="电话号码" Width="200px" Required="true" ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                    </Items>
                                </f:Panel>
                            </Items>
                        </f:GroupPanel>
                        <f:GroupPanel ID="GroupPanel2" Layout="Anchor" Title="联系人地址" runat="server">
                            <Items>
                                ...
                                <f:Panel ID="Panel4" Layout="HBox" BoxConfigAlign="Stretch" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        ...
                                        <f:TextBox ID="TextBox8" Label="邮政编码" Width="200px" Required="true" ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                    </Items>
                                </f:Panel>
                            </Items>
                        </f:GroupPanel>
                        <f:GroupPanel ID="GroupPanel3" Layout="Anchor" Title="账单地址" runat="server">
                            <Items>
                                <f:CheckBox runat="server" Checked="true" ID="cbxSameAsContactAddress" OnCheckedChanged="cbxSameAsContactAddress_CheckedChanged"
                                    Text="和联系人地址相同"></f:CheckBox>
                                ...
                                <f:Panel ID="Panel3" Layout="HBox" BoxConfigAlign="Stretch" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        <f:TextBox ID="tbxBillingProvince" Enabled="false" Label="省" BoxFlex="1" Required="true" ShowRedStar="true"
                                            runat="server">
                                        </f:TextBox>
                                        <f:TextBox ID="tbxBillingCity" Enabled="false" Label="市" BoxFlex="1" LabelWidth="50px" Required="true"
                                            ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                        <f:TextBox ID="tbxBillingPostCode" Enabled="false" Label="邮政编码" Width="200px" Required="true" ShowRedStar="true"
                                            runat="server">
                                        </f:TextBox>
                                    </Items>
                                </f:Panel>
                        ...
                        <f:GroupPanel ID="GroupPanel4" Layout="Anchor" Title="付款方式" runat="server">
                            <Items>
                                ...
                                <f:Panel ID="Panel5" Layout="HBox" BoxConfigAlign="Stretch" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        ...
                                        <f:DropDownList ID="DropDownList1" Label="过期时间" Width="180px" CssClass="marginr" Required="true" ShowRedStar="true"
                                            runat="server">
                                        ...
                                        <f:NumberBox ID="TextBox16" ShowLabel="false" NoDecimal="true" NoNegative="true" Text="2014" Width="100px"
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server" ToolbarAlign="Right" Position="Bottom">
                    <Items>
                        <f:Button ID="Button1" IconFont="_Save" Text="提交账单" ValidateForms="Form1" ValidateMessageBox="false" runat="server">
                        </f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
