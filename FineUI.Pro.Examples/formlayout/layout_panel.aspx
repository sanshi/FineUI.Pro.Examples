<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="layout_panel.aspx.cs" Inherits="FineUI.Pro.Examples.form.layout_panel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" IsFluid="true" LabelAlign="Left" BodyPadding="10" RemoveLastFieldsMargin="true" 
        ...
        <br />
        <br />
        注：为表单设置 RemoveLastFieldsMargin="true" 来移除最后一行表单字段的底部外边距。
    </form>
</body>
</html>
