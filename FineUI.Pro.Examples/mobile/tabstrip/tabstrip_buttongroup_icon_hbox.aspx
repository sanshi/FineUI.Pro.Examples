<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_buttongroup_icon_hbox.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_buttongroup_icon_hbox" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
            <Toolbars>
                <f:Toolbar runat="server" CssClass="f-widget-header mytoolbar" Layout="Fit">
                    <Items>
