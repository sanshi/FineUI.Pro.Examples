<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_buttongroup.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_buttongroup" %>
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
            <Toolbars>
                <f:Toolbar ToolbarAlign="Center" runat="server" CssClass="f-widget-header mytoolbar">
                    <Items>
                        <f:ButtonGroup EnablePressGroup="true" runat="server">
                            <Items>
