<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_buttongroup_icontop_hbox_buttonplain.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_buttongroup_icontop_hbox_buttonplain" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false" Layout="Fit">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server" Title="面板标题" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
                <f:TabStrip ID="TabStrip1" ShowBorder="false" EnableDefaultCorner="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
                    <Toolbars>
                        <f:Toolbar runat="server" CssClass="f-toolbar-buttonplain" Position="Bottom" Layout="Fit">
                            <Items>
                                <f:ButtonGroup ID="ButtonGroup1" EnablePressGroup="true" Layout="HBox" runat="server">
                                    <Items>
                                        <f:Button ID="Button1" runat="server" Text="标签一" Icon="Cake" IconAlign="Top" BoxFlex="1" EnablePress="true" Pressed="true">
                                        </f:Button>
                                        <f:Button ID="Button2" runat="server" Text="标签二" IconFont="_Bank" IconAlign="Top" BoxFlex="1" EnablePress="true">
                                        </f:Button>
                                        <f:Button ID="Button3" runat="server" Text="标签三" IconFont="_Group" IconAlign="Top" BoxFlex="1" EnablePress="true">
                                        </f:Button>
                                        <f:Button ID="Button4" runat="server" Text="标签四" IconFont="_Gear" IconAlign="Top" BoxFlex="1" EnablePress="true">
                                        </f:Button>
                                    </Items>
                                    <Listeners>
                    ...
                    <Tabs>
                        ...
                        <f:Tab ID="Tab4" BodyPadding="10px" runat="server" Layout="Fit">
                            <Items>
