<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_button_icon_hbox.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_button_icon_hbox" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
            <Toolbars>
                <f:Toolbar runat="server" CssClass="f-widget-header mytoolbar" Layout="HBox" BoxConfigChildMargin="0 5px 0 0">
                    <Items>
                        ...
                        <f:Button ID="Button3" runat="server" Text="three" IconFont="_Group" BoxFlex="1" Margin="0" EnablePress="true">
                        </f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
