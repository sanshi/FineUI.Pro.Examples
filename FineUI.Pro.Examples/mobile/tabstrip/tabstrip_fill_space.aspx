<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_fill_space.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_fill_space" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" ActiveTabIndex="1" runat="server"
            TabBorderColor="true" TabFill="true" TabSpace="-1">
            <Tabs>
                ...
                <f:Tab Title="标签二" BodyPadding="10px" runat="server" Layout="Fit">
                    <Items>
                ...
                <f:Tab Title="标签三" BodyPadding="10px" runat="server" Layout="Fit">
                    <Items>
