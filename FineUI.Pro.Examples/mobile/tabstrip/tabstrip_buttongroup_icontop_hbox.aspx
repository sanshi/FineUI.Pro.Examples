<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_buttongroup_icontop_hbox.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_buttongroup_icontop_hbox" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false" Layout="Fit">
            ...
            <Items>
                <f:TabStrip ID="TabStrip1" ShowBorder="false" EnableDefaultCorner="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
                    <Toolbars>
                        <f:Toolbar runat="server" HeaderStyle="true" Position="Bottom" Layout="Fit">
                            <Items>
