<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_buttongroup_icon_hbox_buttonplain.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_buttongroup_icon_hbox_buttonplain" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
            <Toolbars>
                <f:Toolbar runat="server" CssClass="f-toolbar-buttonplain" Layout="Fit">
                    <Items>
                        <f:ButtonGroup ID="ButtonGroup1" EnablePressGroup="true" Layout="HBox" runat="server">
                            <Items>
                                <f:Button ID="Button1" runat="server" Text="one" Icon="Cake" BoxFlex="1" EnablePress="true" Pressed="true">
                                </f:Button>
                                <f:Button ID="Button2" runat="server" Text="two" IconFont="_Bank" BoxFlex="1" EnablePress="true">
                                </f:Button>
                                <f:Button ID="Button3" runat="server" Text="three" IconFont="_Group" BoxFlex="1" EnablePress="true">
                                </f:Button>
                            </Items>
                            <Listeners>
