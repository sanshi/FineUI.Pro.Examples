<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_fill.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_fill" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" ActiveTabIndex="1" runat="server" TabBorderColor="true" TabFill="true">
            <Tabs>
                <f:Tab Title="标签一" BodyPadding="10px" Layout="Fit"
                    runat="server">
                    <Items>
