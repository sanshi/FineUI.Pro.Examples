<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tabstrip_button_icontop_hbox.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.tabstrip.tabstrip_button_icontop_hbox" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false" Layout="Fit">
            ...
            <Items>
                <f:TabStrip ID="TabStrip1" ShowBorder="false" EnableDefaultCorner="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
                    <Toolbars>
                        <f:Toolbar runat="server" CssClass="f-widget-header mytoolbar" Position="Bottom" Layout="HBox" BoxConfigChildMargin="0 5px 0 0">
                            <Items>
                                ...
                                <f:Button ID="Button3" runat="server" Text="标签三" IconFont="_Group" IconAlign="Top" BoxFlex="1" Margin="0" EnablePress="true">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
