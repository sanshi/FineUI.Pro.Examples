<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_position_actionsheet_buttongroup.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.window.window_position_actionsheet_buttongroup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window runat="server" ID="Window1" CssClass="mywindow" ShowHeader="false" ShowBorder="false" Hidden="true" HideOnMaskClick="true"
            ...
            <Items>
                <f:ButtonGroup runat="server" MarginBottom="10px" Layout="HBox">
                    <f:Button runat="server" ID="Button1" Size="Large" BoxFlex="1" Text="相册" ClickHandler="onOpenAlbumClick"></f:Button>
                    <f:Button runat="server" ID="Button2" Size="Large" BoxFlex="1" Text="拍照" ClickHandler="onTakeAPictureClick"></f:Button>
                </f:ButtonGroup>
