<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buttongroup_tabstrip.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.button.buttongroup_tabstrip" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" Layout="VBox" BodyPadding="10px" runat="server">
            <Items>
                <f:ButtonGroup ID="ButtonGroup1" Layout="HBox" BoxConfigPosition="Center" EnablePressGroup="true" runat="server">
                    <Items>
                        <f:Button ID="Button1" runat="server" Text="One" Icon="Cake" EnablePress="true" Pressed="true">
                        </f:Button>
                        <f:Button ID="Button2" runat="server" Text="Two" IconFont="_Bank" EnablePress="true">
                        </f:Button>
                        <f:Button ID="Button3" runat="server" Text="Three" IconFont="_Group" EnablePress="true">
                        </f:Button>
                    </Items>
                    <Listeners>
                ...
                <f:TabStrip ID="TabStrip1" BoxFlex="1" ShowBorder="false" runat="server" ActiveTabIndex="0" ShowTabHeader="false">
                    <Tabs>
                        <f:Tab ID="Tab1" Layout="Fit" runat="server">
                            <Items>
                        ...
                        <f:Tab ID="Tab2" runat="server" Layout="Fit">
                            <Items>
                        ...
                        <f:Tab ID="Tab3" runat="server" Layout="Fit">
                            <Items>
