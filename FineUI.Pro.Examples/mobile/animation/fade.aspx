<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fade.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.animation.fade" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false" Layout="VBox" BoxConfigChildMargin="0 0 10 0"
            ...
            <Toolbars>
                <f:Toolbar runat="server" Title="淡出动画" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
    ...
    <script>
        ...
        function onGotoPanel2Click(event) {
            F.fade(panel1, panel2);
        }

        function onBacktoPanel1Click(event) {
            F.fade(panel2, panel1);
        }
