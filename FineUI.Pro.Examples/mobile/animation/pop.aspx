<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.animation.pop" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false" Layout="VBox" BoxConfigChildMargin="0 0 10 0"
            ...
            <Toolbars>
                <f:Toolbar runat="server" Title="弹出动画" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
