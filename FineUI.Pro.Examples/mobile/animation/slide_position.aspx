<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slide_position.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.animation.slide_position" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowHeader="false" ShowBorder="false"
            BodyPadding="10px" IsViewPort="true" Layout="VBox" BoxConfigChildMargin="0 0 10 0">
            <Toolbars>
            ...
            <Items>
                ...
                <f:Button ID="Button1" runat="server" Text="转到面板 2（向左滑动）" MarginBottom="10" ClickHandler="onSlideLeftClick"></f:Button>
                <f:Button ID="Button2" runat="server" Text="转到面板 2（向右滑动）" MarginBottom="10" ClickHandler="onSlideRightClick"></f:Button>
                <f:Button ID="Button3" runat="server" Text="转到面板 2（向上滑动）" MarginBottom="10" ClickHandler="onSlideUpClick"></f:Button>
                <f:Button ID="Button5" runat="server" Text="转到面板 2（向下滑动）" MarginBottom="10" ClickHandler="onSlideDownClick"></f:Button>
            </Items>
        </f:Panel>
    ...
    <script>
        ...
        function onSlideLeftClick(event) {
            backPosition = 'right';
            F.slideLeft(panel1, panel2);
        }

        function onSlideRightClick(event) {
            backPosition = 'left';
            F.slideRight(panel1, panel2);
        }

        function onSlideUpClick(event) {
            backPosition = 'down';
            F.slideUp(panel1, panel2);
        }

        function onSlideDownClick(event) {
            backPosition = 'up';
            F.slideDown(panel1, panel2);
        }

        function onBacktoPanel1Click(event) {
            F.slide(panel2, panel1, backPosition);
        }
