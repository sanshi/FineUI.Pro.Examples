<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datalist_image_title_button.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.datalist.datalist_image_title_button" %>
...
<body>
    ...
    <script>
        ...
        F.ready(function () {
            ...
            F(dataList1).el.find('.f-datalist-item-inner .item-table .actions').each(function () {
                F.create({
                    type: 'Button',
                    text: '详情',
                    scale: 'small',
            ...
            F(dataList1).el.on('click', '.f-datalist-item-inner .mybtn', function (event) {
