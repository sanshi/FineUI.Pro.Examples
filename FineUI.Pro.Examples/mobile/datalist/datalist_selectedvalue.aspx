<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datalist_selectedvalue.aspx.cs" Inherits="FineUI.Pro.Examples.mobile.datalist.datalist_selectedvalue" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="true" runat="server">
            ...
            <Items>
                <f:DataList runat="server" ID="DataList1" OnItemDataBound="DataList1_ItemDataBound"
                    EnableSelect="true" DataValueField="Id">
                </f:DataList>
            </Items>
        </f:Panel>
    </form>
