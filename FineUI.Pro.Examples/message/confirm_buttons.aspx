<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirm_buttons.aspx.cs"
    Inherits="FineUI.Pro.Examples.message.confirm_buttons" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Button Text="操作一（自定义对话框按钮文本）" runat="server" ID="btnOperation1" ClickHandler="onOperation1Click"></f:Button>
    </form>
