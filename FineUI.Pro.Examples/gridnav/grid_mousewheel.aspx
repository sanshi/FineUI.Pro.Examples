<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_mousewheel.aspx.cs"
    Inherits="FineUI.Pro.Examples.gridnav.grid_mousewheel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" Title="表格" EnableCollapse="false" ShowBorder="true" ShowHeader="true"
            ...
            ShowSelectedCell="true" MouseWheelSelection="true">
            <Columns>
                <f:RowNumberField />
