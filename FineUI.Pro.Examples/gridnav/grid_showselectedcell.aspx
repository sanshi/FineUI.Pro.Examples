<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_showselectedcell.aspx.cs" Inherits="FineUI.Pro.Examples.gridnav.grid_showselectedcell" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ul>
            ...
            <li>ShowSelectedCell：显式选中单元格样式</li>
        </ul>
    </form>
</body>
</html>
