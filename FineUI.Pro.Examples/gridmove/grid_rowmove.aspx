<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_rowmove.aspx.cs" Inherits="FineUI.Pro.Examples.grid.grid_rowmove" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            EnableMultiSelect="false" DataIDField="Id">
            <Columns>
