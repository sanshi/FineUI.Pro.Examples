...
namespace FineUI.Pro.Examples
{
    ...
    {
        /// <summary>
        /// 转义 DataView.RowFilter 的 LIKE 值：* % [ ] 用方括号包起来，单引号翻倍。
        /// 不转义的话，用户在筛选框里输入 [ 就会让 RowFilter 语法出错、直接抛异常。
        /// 出处：http://www.csharp-examples.net/dataview-rowfilter/
        /// </summary>
        ...
        public static DataTable GetDataTable()
        {
            ...
            row[5] = 1;
            row[6] = 0;
            row[7] = DateTime.Now.AddDays(-1); // DBNull.Value;
