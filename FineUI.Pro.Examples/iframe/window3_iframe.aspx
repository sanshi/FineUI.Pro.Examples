<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window3_iframe.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.window3_iframe" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" CssClass="f-widget-content" Layout="Fit" BodyPadding="10px"
            runat="server">
            <Toolbars>
                <f:Toolbar runat="server">
                    <Items>
                        ...
                        <f:Button ID="btnClosePostBack" Text="保存数据" ValidateForms="SimpleForm1"
                            OnClick="btnClosePostBack_Click" Icon="SystemSave"
                            runat="server">
                        </f:Button>
                    </Items>
                </f:Toolbar>
