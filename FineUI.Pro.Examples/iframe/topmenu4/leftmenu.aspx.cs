...
namespace FineUI.Pro.Examples.iframe.topmenu4
{
    public partial class leftmenu : PageBase
    {
        ...
        private void BindLeftTree(string menuType)
        {
            ...
            if (menuType == "mail")
            {
                XmlDataSource1.DataFile = "~/iframe/topmenu4/data/menuMail.xml";
            }
            else if (menuType == "sys")
            {
                XmlDataSource1.DataFile = "~/iframe/topmenu4/data/menuSYS.xml";
            }
            else if (menuType == "sms")
            {
                XmlDataSource1.DataFile = "~/iframe/topmenu4/data/menuSMS.xml";
            }
