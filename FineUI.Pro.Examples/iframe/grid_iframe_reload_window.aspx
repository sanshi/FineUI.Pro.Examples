<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="grid_iframe_reload_window.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.grid_iframe_reload_window" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" CssClass="f-widget-content" AutoScroll="true" BodyPadding="10px" runat="server">
            <Toolbars>
