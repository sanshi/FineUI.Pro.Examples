<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_iframe_alert_script.aspx.cs" Inherits="FineUI.Pro.Examples.iframe.grid_iframe_alert_script" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title></title>
    <meta name="sourcefiles" content="~/iframe/grid_iframe_alert_script_window.aspx" />
</head>
<body>
                ...
                <f:Grid DataIDField="Id" ID="Grid2" Title="Grid2" PageSize="10" ShowBorder="true" BoxFlex="1" AllowPaging="true" IsDatabasePaging="false"
                    ...
                    <Columns>
                        ...
                        <f:WindowField ColumnID="myWindowField" TextAlign="Center" WindowID="Window1" Icon="Pencil" ToolTip="编辑" DataIFrameUrlFields="Id,Name"
                            DataIFrameUrlFormatString="./grid_iframe_alert_script_window.aspx?id={0}&name={1}" Title="编辑" IFrameUrl="~/alert.aspx" />
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
    ...
    <script>
        function closeWindow1(closeArgument) {
            F.customEvent('CloseWindow1', closeArgument);
        }
