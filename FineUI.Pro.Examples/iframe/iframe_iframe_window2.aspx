<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iframe_iframe_window2.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.iframe_iframe_window2" %>
        ...
        <f:Panel ID="formPanel" ShowBorder="false" ShowHeader="false" CssClass="f-widget-content" Layout="Fit" runat="server">
            <Toolbars>
                <f:Toolbar runat="server">
                    <Items>
                        <f:Button ID="btnClosePostBack" Text="回发父页面" runat="server" ClickHandler="onClosePostBackClick">
                        </f:Button>
                        <f:Button ID="btnPostBackClosePostBack" Text="回发父页面（后台注册脚本）" OnClick="btnPostBackClosePostBack_Click"
                            runat="server">
                        </f:Button>
                    </Items>
                </f:Toolbar>
