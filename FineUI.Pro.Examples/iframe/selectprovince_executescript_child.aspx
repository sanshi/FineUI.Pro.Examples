<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectprovince_executescript_child.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.selectprovince_executescript_child" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" CssClass="f-widget-content" BodyPadding="10px" runat="server">
            <Items>
    ...
    <script>
        ...
        function select(provinceName) {
            F.customEvent('SelectProvince', provinceName);
        }
