<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iframe_closeall_window1.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.iframe_closeall_window1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window1" Hidden="true" EnableIFrame="true" runat="server"
            ...
            Title="窗体三" OnClose="Window1_Close">
        </f:Window>
        <f:Window ID="Window2" Hidden="true" EnableIFrame="true" runat="server"
            ...
            CloseAction="HidePostBack" Title="窗体四" OnClose="Window2_Close">
        </f:Window>
    ...
    <script>
        ...
        function onOpenWindow1Click(event) {
            F(Window1ClientID).show('<%= ResolveUrl("~/iframe/iframe_closeall_window2.aspx") %>');
        }

        function onOpenWindow2Click(event) {
            F(Window2ClientID).show('<%= ResolveUrl("~/iframe/iframe_closeall_window2.aspx") %>');
        }
