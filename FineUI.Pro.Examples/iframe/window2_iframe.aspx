<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window2_iframe.aspx.cs"
    Inherits="FineUI.Pro.Examples.iframe.window2_iframe" %>
...
<body>
    <form id="form1" runat="server">
        <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" EnableFormChangeConfirm="true" runat="server" />
    ...
    <script>
        ...
        function saveWindow() {
            if (F.validateForm(SimpleForm1ClientID, { target: '_top' })) {
                F.customEvent('SAVE');
            }
        }
    </script>
