<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_singleselect_radio.aspx.cs" Inherits="FineUI.Pro.Examples.gridcard.card_singleselect_radio" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            ...
            EnableCheckBoxSelect="true" EnableMultiSelect="false" CheckBoxSelectDisplayType="Radio">
            <Columns>
                <f:RowNumberField />
