<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_showselectedrow.aspx.cs" Inherits="FineUI.Pro.Examples.gridcard.card_showselectedrow" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            DataIdField="Id" Height="500px" DisplayType="Card" CardRendererFunction="renderCard" ShowSelectedRow="false">
            <Columns>
                <f:RowNumberField />
