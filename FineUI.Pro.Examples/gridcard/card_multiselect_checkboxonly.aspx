<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_multiselect_checkboxonly.aspx.cs" Inherits="FineUI.Pro.Examples.gridcard.card_multiselect_checkboxonly" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            ...
            EnableCheckBoxSelect="true" CheckBoxSelectOnly="true">
            <Columns>
                <f:RowNumberField />
