<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_paging_database.aspx.cs" Inherits="FineUI.Pro.Examples.gridcard.card_paging_database" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            ...
            AllowPaging="true" IsDatabasePaging="true" PageSize="10" OnPageIndexChanged="Grid1_PageIndexChanged">
            <Columns>
                <f:RowNumberField />
