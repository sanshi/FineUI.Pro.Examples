<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_paging.aspx.cs" Inherits="FineUI.Pro.Examples.gridcard.card_paging" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" ShowBorder="true" ShowHeader="true" Title="表格" runat="server" EnableCollapse="false"
            ...
            AllowPaging="true" IsDatabasePaging="false" PageSize="10">
            <Columns>
                <f:RowNumberField />
